 ...
 */
public class ListTalkbyTypeAction extends Action {
	...
	public ActionForward execute(
		...
		String typeoftalkid = (String)request.getParameter("typeoftalk_id");
		...
		String sql = "call sp_listTalksByType(?);";
		
		try{
			pstmt = conn.conn.prepareStatement(sql);
			pstmt.setInt(1,Integer.parseInt(typeoftalkid));
			pstmt.execute();
