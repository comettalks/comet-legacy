 ...
 */
public class ListTalkbySpeakerAction extends Action {
	...
	public ActionForward execute(
		...
		String speakerid = (String)request.getParameter("speaker_id");
		...
		String sql = "call sp_listTalksBySpeaker(?);";
		
		try{
			pstmt = conn.conn.prepareStatement(sql);
			pstmt.setInt(1,Integer.parseInt(speakerid));
			pstmt.execute();
