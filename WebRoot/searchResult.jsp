...
<%
	...
	try
	{
		String url;
		if (option.equals("4"))
			 url = "http://127.0.0.1/solr/db/select/?q=" + query + "&version=2.2&start=" + startDoc + "&rows=10&indent=on&sort=" + sort + "&facet=true&facet.field=video&facet.field=slide&facet.field=sponsor_str&facet.field=date&facet.mincount=1&facet.query=date:[NOW-3MONTHS%20TO%20NOW]&facet.query=date:[NOW-1MONTHS%20TO%20NOW]&facet.query=date:[NOW-30DAYS%20TO%20NOW]&facet.query=date:[NOW%20TO%20NOW%2B30DAYS]&facet.query=date:[NOW%20TO%20NOW%2B1MONTHS]&facet.query=date:[NOW%20TO%20NOW%2B3MONTHS]";
		else{	
			if (option.equals("1"))
				opt = "title";
			...
			url = "http://127.0.0.1/solr/db/select/?q=" + opt + "%3A+" + query + "&version=2.2&start=" + startDoc + "&rows=10&indent=on&sort=" + sort + "&facet=true&facet.field=video&facet.field=slide&facet.field=sponsor_str&facet.field=date&facet.mincount=1&facet.query=date:[NOW-3MONTHS%20TO%20NOW]&facet.query=date:[NOW-1MONTHS%20TO%20NOW]&facet.query=date:[NOW-30DAYS%20TO%20NOW]&facet.query=date:[NOW%20TO%20NOW%2B30DAYS]&facet.query=date:[NOW%20TO%20NOW%2B1MONTHS]&facet.query=date:[NOW%20TO%20NOW%2B3MONTHS]";		
